...
RendererTests::RendererTests() {
    ...
    vertices = arrayToVertexVector(verticesArray, sizeof(verticesArray) / sizeof(verticesArray[0]));
    indices = arrayToGLuintVector(indicesArray, sizeof(indicesArray) / sizeof(indicesArray[0]));

    Mesh mesh(vertices, indices);
    Shader shader("./Resources/Shaders/VertexTextures.glsl", "./Resources/Shaders/fragmentTextures.glsl");
    Camera camera(glm::vec3(0.0f, 0.0f, 3.0f));
    Texture texture("./Resources/Textures/dirt.png");

    Renderer renderer = Renderer(mesh, shader, camera, texture);
}
